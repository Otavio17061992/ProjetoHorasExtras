...
namespace SmartHorasExtras.Views
{
    public partial class TelaConfiguracoes : Form
    {
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            ...
            string diretorio = INiFilesPadrao.IniReadValue(tela_prinpical.caminhoDiretorioIni+ "\\Caminho.ini", "BancoDados", "Caminho");

            INiFilesPadrao iniPath = new INiFilesPadrao(diretorio);

            iniPath.AddSetting("BancoDados", "Caminho");

            iniPath.SaveSettings();

            string retorn = INiFilesPadrao.IniReadValue(textBoxCaminho.Text + "\\Caminho.ini", "BancoDados", "Caminho");
