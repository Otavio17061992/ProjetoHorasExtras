...
namespace SmartHorasExtras
{
    public partial class TelaPrincipal : Form
    {
        ...
        public string caminhoDiretorioIni = @"C:\ControleHorasExtras\Caminho.ini";
        ...
        {
            // le caminho Ini para banco de dados 
            string retorn = INiFilesPadrao.IniReadValue(caminhoDiretorioIni, "BancoDados","caminho");
        ...
        {
            AbrirTela<TelaColaboradoresTabela>();
        }
