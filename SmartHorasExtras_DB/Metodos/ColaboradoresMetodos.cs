...
namespace SmartHorasExtras_DB.Metodos
{
    public class ColaboradoresMetodos
    {
        ...
        {
            using (var con = new SQLiteConnection("Data Source="+BancoDadosMetodos.conexao+"SmartHorasExtras.db;Version=3;"))
            {
        ...
        {
            using (SQLiteConnection conn = new SQLiteConnection("Data Source=" + BancoDadosMetodos.conexao + "SmartHorasExtras.db;Version=3;"))
            {
                conn.Open();
        ...
        {
            using (SQLiteConnection conn = new SQLiteConnection("Data Source=" + BancoDadosMetodos.conexao + "SmartHorasExtras.db"))
            {
                conn.Open();
        ...
        {
            using (SQLiteConnection connection = new SQLiteConnection("Data Source=" + BancoDadosMetodos.conexao + "SmartHorasExtras.db"))
            {
                connection.Open();
